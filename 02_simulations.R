...
n_sims <- 100000
priors <- data.frame(n_init_west = round(runif(n_sims, 5000, 50000)),
...
#run simulations
simulations <- parallel::mclapply(1:n_sims, function(x){simple_model(as.numeric(priors[x, ]), regio_dists)}, mc.cores = 95)
